...
Hacer uso en la programación de abstracción, encapsulados, herencia y polimorfismo. 

Diseñar un sistema de reservas ejecutar métodos de sobrecarga para cálculos rápidos de costos 
